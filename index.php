...
// Show EOL message
$message = sprintf(
    __('GenericObject v%s is End-of-Life. All genericobject functionality is now available in GLPI 11 core. Check migration status or use native custom assets.', 'genericobject'),

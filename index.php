...
foreach($datas as $ID => $value)
{
	if (plugin_genericobject_haveRight($value["name"],'r'))
		echo "<tr class='tab_bg_1'><td align='center'><a href=\"./front/search.php?itemtype=PluginGenericobject".ucfirst($value["itemtype"])."\">".plugin_genericobject_getObjectLabel($value["name"])."</a></td></tr>";
}
